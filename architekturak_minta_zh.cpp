...
int main()
{
    ...
    _asm
    {
        ...
        mov eax, ebx;
        mul ebx;
        mov edx, eax;   //EAX:EDX párost használjuk ilyen műveleteknél
    }

    //4. feladat - Ossza el 120-at 58-al egész típusú műveletekkel!
    _asm
    {
        mov eax, 120;
        mov ecx, 58;
    ...
    /*
    Készítse el a gondoltam egy számot játékot _asm blokkokkal a következő elemekkel:
    - A gondolt szám tartománya 1 és 1000 közé essen.
    - Számolja meg a találatok számát, és jegyezze meg a későbbi játék során.
    - Addig játsszon a játékos, ameddig csak akar (legyen a végén egy új játék lehetőség)
